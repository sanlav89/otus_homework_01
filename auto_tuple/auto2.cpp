...
//        auto& v2 = func_value(); // 1.2 - v2 type 'int &'
...
//        auto& v2 = func_rref(); // 7.2 - v2 type 'int &'
    ...
    }
    {
        ...
        auto v4 = {10}; // 8.4 - v4 'std::initializer_list<int>'
        auto v5 = {1, 2, 3}; // 8.5 - v5 type 'std::initializer_list<int>'
//        auto v6 = {1, 2, 3.0}; // 8.6 - v6 type 'std::initializer_list<int or double>'
    }
    return 0;
}
